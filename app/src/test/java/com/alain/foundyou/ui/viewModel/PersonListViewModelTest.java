...
public class PersonListViewModelTest {
    ...
    public void setUp() {
        ...
        // Mock the initial database check to avoid triggering refreshData in the constructor
        // We return a list with one item, so personList.isEmpty() is false.
    ...
    public void testRefreshData_Success() {
        ...
        // Then
        // Verify that refreshPersons was called
        verify(personRepository).refreshPersons();

        // Verify that isLoading LiveData is updated to true and then false
    ...
    public void testRefreshData_Error() {
        ...
        // Verify that the error LiveData is updated with the error message
